package kr.co.lia.photopicker.fragment;
...
import static kr.co.lia.photopicker.utils.MediaStoreHelper.INDEX_ALL_PHOTOS;
...
public class PhotoPickerFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getActivity() instanceof PhotoPickerActivity) {
            ...
            mediaStoreArgs.putBoolean(EXTRA_SHOW_GIF, YPhotoPickerIntent.checkGif);
        }
